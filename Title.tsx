import * as React from 'react';
 function Title () {
  ...
  return (
    ...
    <p>UseCallback hook returns a memoized version of the callback function that is passed to optimized child components to prevent re-renders which changes only  if one of the dependencies change.</p>
    </div>
  )
}
